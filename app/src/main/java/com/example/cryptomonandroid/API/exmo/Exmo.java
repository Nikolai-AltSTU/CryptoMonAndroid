package com.example.cryptomonandroid.API.exmo;
...
public class Exmo {
    ...
    public final String Request(String method, HashMap<String, String> arguments) {
        Mac mac;
        SecretKeySpec key;
        String sign;
        ...
        for (HashMap.Entry<String, String> stringStringEntry : arguments.entrySet()) {
            HashMap.Entry argument = (HashMap.Entry) stringStringEntry;
        ...
        try {
            sign = String.valueOf( Hex.encodeHex(mac.doFinal(postData.getBytes("UTF-8"))) );
        } catch (UnsupportedEncodingException uee) {
            System.err.println("Unsupported encoding exception: " + uee.toString());
            return null;
        }
